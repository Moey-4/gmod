...
-- Keypad Order Minigame
local function RunKeypadGame()
    local nums = {1, 2, 3, 4}
    table.Shuffle(nums)
...
-- Listen for hacking minigame start
net.Receive("OpenHackingMinigame", function()
    local choice = math.random(1, 4)
    if choice == 1 then
        vgui.Create("Hacking_Skillbar")
